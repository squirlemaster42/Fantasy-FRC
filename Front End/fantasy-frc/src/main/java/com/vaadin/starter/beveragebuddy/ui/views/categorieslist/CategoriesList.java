...
public class CategoriesList extends VerticalLayout {
    ...
    private final H2 header = new H2("Number of Teams for Each Category");
    ...
    private void addSearchBar() {
        ...
        Button newButton = new Button("Log in", new Icon("lumo", "plus"));
    ...
    private void addContent() {
        ...
        grid.addColumn(Category::getName).setHeader("Categories").setWidth("8em").setResizable(true);
        grid.addColumn(this::getReviewCount).setHeader("Teams").setWidth("6em");
    ...
    private void updateView() {
        ...
        if (searchField.getValue().length() > 0) {
            ...
            header.setText("Number of Teams in each Category");
        }
    }
