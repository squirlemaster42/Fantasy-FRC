...
public class ReviewsList extends PolymerTemplate<ReviewsModel> {
    ...
    private TeamConfirmDialog reviewForm = new TeamConfirmDialog(
    ...
    public void saveUpdate(Review review,
        ...
        updateList();
        Notification.show(
                "Team successfully " + operation.getNameInText() + "ed.",
    ...
    public void deleteUpdate(Review review) {
        ...
        updateList();
        Notification.show("Team successfully deleted.", 3000,
